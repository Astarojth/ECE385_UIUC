...
module lab9_soc_mm_interconnect_0 (
	...
	wire    [8:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> VGA_text_mode_controller_0_avl_mm_slave_agent:cp_channel
	...
	wire  [106:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> onchip_memory2_0_s2_agent:cp_data
	...
	wire  [106:0] onchip_memory2_0_s2_agent_rp_data;                                                  // onchip_memory2_0_s2_agent:rp_data -> router_010:sink_data
	...
	wire  [106:0] cmd_demux_001_src5_data;                                                            // cmd_demux_001:src5_data -> cmd_mux_008:sink1_data
	...
	wire  [106:0] rsp_demux_008_src1_data;                                                            // rsp_demux_008:src1_data -> rsp_mux_001:sink5_data
	...
	wire  [106:0] cmd_demux_001_src4_data;                                                            // cmd_demux_001:src4_data -> crosser_002:in_data
	...
	wire    [8:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> cmd_mux_006:sink1_channel
	...
	wire  [106:0] rsp_demux_001_src0_data;                                                            // rsp_demux_001:src0_data -> crosser_003:in_data
	...
	wire  [106:0] crosser_003_out_data;                                                               // crosser_003:out_data -> rsp_mux:sink1_data
	...
	wire    [8:0] rsp_demux_006_src0_channel;                                                         // rsp_demux_006:src0_channel -> crosser_004:in_channel
	...
	wire    [8:0] crosser_004_out_channel;                                                            // crosser_004:out_channel -> rsp_mux:sink6_channel
	...
	wire    [8:0] rsp_demux_006_src1_channel;                                                         // rsp_demux_006:src1_channel -> crosser_005:in_channel
	...
	wire          crosser_005_out_valid;                                                              // crosser_005:out_valid -> rsp_mux_001:sink4_valid
	wire  [106:0] crosser_005_out_data;                                                               // crosser_005:out_data -> rsp_mux_001:sink4_data
	wire          crosser_005_out_ready;                                                              // rsp_mux_001:sink4_ready -> crosser_005:out_ready
	wire    [8:0] crosser_005_out_channel;                                                            // crosser_005:out_channel -> rsp_mux_001:sink4_channel
	wire          crosser_005_out_startofpacket;                                                      // crosser_005:out_startofpacket -> rsp_mux_001:sink4_startofpacket
	wire          crosser_005_out_endofpacket;                                                        // crosser_005:out_endofpacket -> rsp_mux_001:sink4_endofpacket
	...
	lab9_soc_mm_interconnect_0_router_004 router_010 (
	...
	lab9_soc_mm_interconnect_0_cmd_mux_002 cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab9_soc_mm_interconnect_0_rsp_demux_002 rsp_demux_008 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
